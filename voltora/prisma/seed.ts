  ...
  const productsData = [
    {
      ...
      best: true,
      variants: [
        { name: "128GB / Midnight", sku: "VT-PH-001-128-BK", color: "Midnight", storage: "128GB", stock: 18, mod: 0 },
        { name: "256GB / Midnight", sku: "VT-PH-001-256-BK", color: "Midnight", storage: "256GB", stock: 14, mod: 100 },
        { name: "256GB / Silver", sku: "VT-PH-001-256-SV", color: "Silver", storage: "256GB", stock: 10, mod: 100 },
      ],
    },
    {
      sku: "VT-LP-002",
      ...
      best: true,
      variants: [
        { name: "16GB / 512GB", sku: "VT-LP-002-16-512", storage: "512GB", stock: 16, mod: 0 },
        { name: "32GB / 1TB", sku: "VT-LP-002-32-1TB", storage: "1TB", stock: 12, mod: 250 },
      ],
    },
    {
      sku: "VT-TB-003",
    ...
    },
    {
      ...
      trending: true,
      variants: [
        { name: "Black Sport Band", sku: "VT-SW-004-BK", color: "Black", stock: 25, mod: 0 },
        { name: "Silver Metal Band", sku: "VT-SW-004-SV", color: "Silver", stock: 25, mod: 40 },
      ],
    },
    {
      sku: "VT-EB-005",
    ...
    },
    {
      ...
      mainImage: "https://images.unsplash.com/photo-1609091839311-b48b3ebaa53b?w=800&q=80",
      images: ["https://images.unsplash.com/photo-1609091839311-b48b3ebaa53b?w=800&q=80"],
      originalPrice: 79,
      sellingPrice: 59,
      stock: 120,
      badges: ["Best Seller", "Hot Deal"],
